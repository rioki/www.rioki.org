...
I have tried numerous hosting solutions over the years. Up until recently, 
...
shrunk, especially since I discovered jekyll.

Currently I have one website (this one) and it is fully static. This requirement
especially does not warrant a fully fledged VPS. For some time I ran my site off
[github pages][8]. But since github does not allow jekyll plugins, the entire 
